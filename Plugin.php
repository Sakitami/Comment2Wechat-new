 ...
 * @author Sakitami
 * @version 1.1.1
 * @link https://github.com/Sakitami
 */
class Comment2Wechat_Plugin implements Typecho_Plugin_Interface
{
    ...
    {
        $key = new Typecho_Widget_Helper_Form_Element_Text('sckey', NULL, NULL, _t('SCKEY'), _t('SCKEY 需要在 <a href="http://sct.ftqq.com/">Server酱</a> 注册<br />
        同时，注册后需要在 <a href="http://sct.ftqq.com/">Server酱</a> 绑定你的企业微信号才能收到推送'));
    ...
    public static function sc_send($comment, $post)
    {
        ...
        $result = file_get_contents('http://sct.ftqq.com/'.$sckey.'.send', false, $context);
        return  $comment;
    }
}
